...
TF_A_OUT		?= $(TF_A_PATH)/build/rpi5/debug
TF_A_BOOT		?= $(TF_A_OUT)/bl31.bin
...
TF_A_FLAGS ?= \
	...
	LOG_LEVEL=40 \
	PLAT=rpi5 \
	RPI5_PRELOADED_DTB_BASE=0x00010000 \
	SPD=opteed
...
update_bootfs: tf-a linux u-boot-env
	...
	@install -v -p --mode=755 $(TF_A_BOOT) $(BOOT_PARTITION_FILES)/bl31.bin
