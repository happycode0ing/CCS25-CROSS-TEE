 ...
 *      Author: 27951
 */
#include "nsc_bsp_canfd0.h"

can_callback_args_t canfd0_callback_args;
//volatile uint64_t canfd0_call_nums = 0;

/* CAN 初始化函数 */
void CANFD0_Init(void)
{
    fsp_err_t err = FSP_GUARD_g_canfd0_R_CANFD_Open();

    err = FSP_GUARD_g_canfd0_R_CANFD_CallbackSet(canfd0_callback, NULL, &canfd0_callback_args);
